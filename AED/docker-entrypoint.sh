...
CONNEXION_FILE=webapps/CAST-AED/META-INF/context.xml
sed -i 's/${domainName}/'"$AED_DOMAIN"'/g' ${CONNEXION_FILE}
...
USER_FILE=webapps/CAST-AED/WEB-INF/users.properties
